    ...
    <div class="admin-main">
        <div class="admin-section admin-form-section">
            ...
            <div class="admin-form-header">
                ...
                <div>
                    <h1>Add New Song</h1>
                    <p class="admin-form-sub">Add a new song to the library</p>
                </div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/admin/songs" method="post" class="admin-form">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="title" placeholder="e.g. Bohemian Rhapsody" required>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="artist" placeholder="e.g. Queen" required>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="genre" placeholder="e.g. Rock" required>
                </div>

                <div class="admin-form-actions">
                    <button type="submit" class="btn-primary-full btn-form-submit">Add Song</button>
